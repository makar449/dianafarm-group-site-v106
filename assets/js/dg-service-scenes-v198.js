...
(function(){
  'use strict';
  var VERSION = 'v198-premium-fixed-in-hero-interactive-scenes';
  var SCENE_BY_PAGE = {
  ...
  var state = window.DG_PRO_SCENES_V198 = {version:VERSION, mounted:false, frames:0, scene:null, kind:null, errors:[], canvas:false, rootExists:false, visible:false};
  window.DG_PRO_SCENES_V196 = state;
