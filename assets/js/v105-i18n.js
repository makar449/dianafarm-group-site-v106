(function () {
  ...
  const common = {
    ru: {
      home: 'Главная', services: 'Услуги', about: 'О компании', blog: 'Блог', b2b: 'B2B Offers', contacts: 'Контакты', allServices: 'Все услуги',
      ...
      proof1: 'Персональный анализ', proof1s: 'без шаблонов и лишней воды', proof2: 'Документы и маршрут', proof2s: 'понятная последовательность действий', proof3: '', proof3s: 'помогаем до результата',
      ...
      steps: ['Заявка', 'Диагностика', 'Стратегия', '', 'Результат'], stepTexts: ['Фиксируем задачу, страну, сроки и ожидания.', 'Проверяем документы, вводные и доступные варианты.', 'Предлагаем понятный маршрут и приоритеты.', 'Помогаем в процессе и коммуникациях.', 'Передаём итог, рекомендации и следующий шаг.']
    },
    bg: {
      home: 'Начало', services: 'Услуги', about: 'За нас', blog: 'Блог', b2b: 'B2B оферти', contacts: 'Контакти', allServices: 'Всички услуги',
      ...
      steps: ['Запитване', 'Диагностика', 'Стратегия', 'Съдействие', 'Резултат'], stepTexts: ['Фиксираме задачата, страната, сроковете и очакванията.', 'Проверяваме документи, входни данни и варианти.', 'Предлагаме ясен маршрут и приоритети.', 'Съпровождаме процеса и комуникацията.', 'Предаваме резултат, препоръки и следваща стъпка.']
    },
    ka: {
      home: 'მთავარი', services: 'სერვისები', about: 'კომპანიის შესახებ', blog: 'ბლოგი', b2b: 'B2B შეთავაზებები', contacts: 'კონტაქტები', allServices: 'ყველა სერვისი',
    ...
    en: {
      home: 'Home', services: 'Services', about: 'About', blog: 'Blog', b2b: 'B2B Offers', contacts: 'Contacts', allServices: 'All services',
      ...
      steps: ['Request', 'Diagnosis', 'Strategy', '', 'Result'], stepTexts: ['We define the task, country, timeline and expectations.', 'We review documents, inputs and available options.', 'We propose a clear route and priorities.', 'We support the process and communication.', 'We deliver the result, recommendations and next step.']
    }
  };
  ...
  function setHero(title, text) {
    ...
    if (titleEl) {
      const safeTitle = document.body.dataset.page === 'about' ? 'DIANAFARM GROUP' : title;
      titleEl.innerHTML = esc(safeTitle).replace(/\s+/, '<br>');
    }
