...
(function(){
  'use strict';
  var VERSION = 'v200-trade-document-bound-canvas-external-js';
  var state = window.DG_TRADE_GLOBE_V200 = {
    version: VERSION,
    mounted: false,
    frames: 0,
    canvas: false,
  ...
  window.DG_TRADE_GLOBE_V195 = state; window.DG_TRADE_GLOBE_V198 = state;
